...
shinyApp(
  ui = fluidPage(
    ...
    sidebarLayout(
      ...
      mainPanel(
        tabsetPanel(
          tabPanel("VORP Distribution", plotOutput("plot1")),
          tabPanel("Years Active Distribution", plotOutput("plot2")),
          tabPanel("Team Draft Success", plotOutput("plot3")),
          tabPanel("Top 5 Players Table", tableOutput("table"))
        )
      )
    )
  ),
